...
public abstract class BlockPlantBiochemical extends BlockPlantBase {
     ...
     */
    protected static final VoxelShape[] BIO_FLOWER_AABB = new VoxelShape[] {
            ...
            Block.makeCuboidShape(0.375D, 0.0D, 0.375D, 0.625D, 0.375D, 0.625D),    //Age=3
            Block.makeCuboidShape(0.375D, 0.0D, 0.375D, 0.625D, 0.50D, 0.625D),     //Age=4
            Block.makeCuboidShape(0.375D, 0.0D, 0.375D, 0.625D, 0.625D, 0.625D),    //Age=5
            Block.makeCuboidShape(0.375D, 0.0D, 0.375D, 0.625D, 0.75D, 0.625D),     //Age=6
            Block.makeCuboidShape(0.375D, 0.0D, 0.375D, 0.625D, 0.875D, 0.625D)     //Age=7
    };
    ...
    protected int getBonemealGrowthStageIncrease(World worldIn){
        return MathUtil.getRandomIntegerInRange(1, 5);
    }
...
//    }
    ...
    public VoxelShape getShape(IBlockState state, IBlockReader worldIn, BlockPos pos) {
        return BIO_FLOWER_AABB[state.get(GROWTH_STAGE)];
    }
...
//    }
    ...
    public boolean canUseBonemeal(World worldIn, Random rand, BlockPos pos, IBlockState state){
        return /*ResynthConfig.PLANTS_GENERAL.canBonemeal && TODO: Configs*/ this.canBonemeal();
    }
