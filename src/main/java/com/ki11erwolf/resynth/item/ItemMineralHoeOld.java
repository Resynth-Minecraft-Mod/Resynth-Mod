...
public class ItemMineralHoeOld extends ResynthItem<ItemMineralHoeOld> {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn,
        ...
        if(stack.getTag() != null)
            tooltip.add(new StringTextComponent(
                    ...
                    + TextFormatting.GREEN + stack.getTag().getInt(NBT_TAG_CHARGES)
            ));
