 ...
 * registered to Waila via the {@link mcp.mobius.waila.api.IRegistrar} instance provided in the original registration callback method
 * (cf. {@link mcp.mobius.waila.api.IRegistrar} documentation for more information).
 *
 * @author ProfMobius
 */
