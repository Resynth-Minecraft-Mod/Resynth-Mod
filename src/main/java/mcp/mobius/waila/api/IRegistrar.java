...
public interface IRegistrar {
     ...
     * @param block The highest level class to apply to
     */
    void registerComponentProvider(IComponentProvider dataProvider, mcp.mobius.waila.api.TooltipPosition position, Class block);

    /**
     * Registers an {@link mcp.mobius.waila.api.IServerDataProvider <TileEntity>} instance for data syncing purposes.
     * A {@link TileEntity} is also an acceptable class type.
     *
     * @param dataProvider The data provider instance
     * @param block The highest level class to apply to
     */
    void registerBlockDataProvider(mcp.mobius.waila.api.IServerDataProvider<TileEntity> dataProvider, Class block);
