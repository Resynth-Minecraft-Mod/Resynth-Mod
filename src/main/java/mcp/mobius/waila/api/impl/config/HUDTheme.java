...
public class HUDTheme {
    ...
    public static final HUDTheme DARK = new HUDTheme(new ResourceLocation("waila", "dark"), 0x131313, 0x383838, 0x242424, 0xA0A0A0);
    ...
    public HUDTheme() {
        this(new ResourceLocation("waila", "vanilla"), 0x100010, 0x5000ff, 0x28007f, 0xA0A0A0);
    }
